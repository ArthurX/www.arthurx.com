...
//            DELETE  the bottom 10 Results.                                                *******************
if (!empty($_POST['delete'])){
$query = "DELETE FROM guestbook WHERE id = $delete";

$result = mysql_query($query) or die(mysql_error());

echo "You have Deleted the results with id:" . $delete .".<p>";
 };
...
while($row = mysql_fetch_array($result)){
    ...
    echo "<tr bgcolor=blue ><td>Name:&nbsp;" . $row['name']. " <td>Email:&nbsp; ". $email. " &nbsp;ID:&nbsp; ". $row['id']. " <td align=right>Date: ". $row['date']."<tr><td colspan=3 bgcolor=red>Subject: ". $row['subject']. " <tr><td>  \n" ;
   #Random_Image($Barcelona_Names , 1) ;
